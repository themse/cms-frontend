        ...
        <div className="row">
          ...
          <div className="col-sm-3">
            ...
            <ul className="list-unstyled">
              ...
              <li>
                <a href="index.php@route=information%252Fsitemap.html">
                  Site Map
                </a>
              </li>
            </ul>
          ...
          <div className="col-sm-3">
            ...
            <ul className="list-unstyled">
              <li>
                <a href="index.php@route=product%252Fmanufacturer.html">
                  Brands
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="index.php@route=affiliate%252Faccount.html">
                  Affiliates
                </a>
              </li>
              <li>
          ...
          <div className="col-sm-3">
            ...
            <ul className="list-unstyled">
              <li>
                <a href="index.php@route=account%252Faccount.html">
                  My Account
                </a>
              </li>
              <li>
                <a href="index.php@route=account%252Forder.html">
                  Order History
                </a>
              </li>
              <li>
                <a href="index.php@route=account%252Fwishlist.html">
                  Wish List
                </a>
              </li>
              <li>
                <a href="index.php@route=account%252Fnewsletter.html">
                  Newsletter
                </a>
              </li>
            </ul>
